...
const HomeLaptopCard = ({ laptop }) => {
    ...
    return (
        <div
            ...
            className="cursor-pointer flex flex-col items-center bg-white rounded-lg shadow-2xl border border-gray-200 overflow-hidden w-[15rem] transform transition-transform hover:scale-105"
        >
            ...
            <div className="p-4">
                ...
                <p className="text-black-500 font-bold">{laptop?.discountedPrice} VND</p>
